        ...
        <div class="row">
            ...
            <section class="4u">
                <span class="pennant">
                 ...
                 {!!__('welcomePage.block3')!!}
                 <br/>
                <a class="button button-style1" href="{{route('leaderboard')}}">
                    {{__('buttons.leaderboard')}}
                </a>
            </section>
        </div>
    </div>
...
@section('content')
    <div id="content">
        ...
        <div class="row">
            ...
            <section class="6u">
                <a class="image full" href="{{route('quizzes.show',['quiz'=>$quiz])}}">
                    <img alt="Quizzes picture" src="images/welcome1{{$loop->index}}.jpg"/>
                </a>
                <header>
                    <h2>
                        <a href="{{route('quizzes.show',['quiz'=>$quiz])}}">
